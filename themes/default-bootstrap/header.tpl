                        ...
                        <a href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}"
                           title="{$shop_name|escape:'html':'UTF-8'}">
                            <img class="logo img-responsive" src="{$logo_url}"
                                 alt="{$shop_name|escape:'html':'UTF-8'}" {if isset($logo_image_width) &&
                                 $logo_image_width} width="{$logo_image_width}" {/if}{if isset($logo_image_height)
                            && $logo_image_height} height="{$logo_image_height}"{/if}/>
                        </a>
                    </div>

                    <div class="right col-xs-12 col-sm-7">
                        {if isset($HOOK_TOP)}{$HOOK_TOP}{/if}
                        <p class="welcome">Welcome to our online store!</p>
                        <ul class="addnav">
                            <li><a href="#">Contact</a></li>
                            <li><a href="#">Sitemap</a></li>
                            <li><a href="#">Bookmark </a></li>
                        </ul>
                        {if isset($HOOK_TOPSEARCH)}{$HOOK_TOPSEARCH}{/if}
                        <div style="clear:both;"></div>
                    </div>
                    {if isset($HOOK_AFTERTOP)}{$HOOK_AFTERTOP}{/if}
    ...
    <div class="columns-container">
        <div id="columns" class="container">
            ...
            <div class="row">
                ...
                <div id="left_column" class="column col-xs-12 col-sm-{$left_column_size|intval}">{$HOOK_LEFT_COLUMN}
                </div>
                {/if}
                {if isset($left_column_size) && isset($right_column_size)}{assign var='cols' value=(12 -

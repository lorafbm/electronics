...
class BlockSearch extends Module
{
	...
	{
		if (!parent::install() || !$this-> registerHook('topsearch') || !$this->registerHook('top') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap') || !$this->registerHook('displaySearch'))
			return false;
		return true;
	}
	...
	public function hookdisplayMobileTopSiteMap($params)
	{
		...
		return $this->hookTopSearch($params);
	}
